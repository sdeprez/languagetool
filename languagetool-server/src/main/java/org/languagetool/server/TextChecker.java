...
abstract class TextChecker {
  ...
  void checkText(AnnotatedText aText, HttpExchange httpExchange, Map<String, String> parameters) throws Exception {
    ...
    if (onlyAutoDetect) {
      buildResponse(aText, httpExchange, parameters, lang, motherTongue, emptyMatches, false, autoDetectLanguage);
      return;
    }
    ...
    buildResponse(aText, httpExchange, parameters, lang, motherTongue, matches, incompleteResult, autoDetectLanguage);
  }

  protected void buildResponse(
      AnnotatedText text, HttpExchange httpExchange, Map<String, String> parameters,
      Language lang, Language motherTongue, List<RuleMatch> matches,
      boolean incompleteResult, boolean autoDetectLanguage
  ) throws Exception {

    setHeaders(httpExchange);
    String response = getResponse(text.getPlainText(), lang, motherTongue, matches, incompleteResult);
